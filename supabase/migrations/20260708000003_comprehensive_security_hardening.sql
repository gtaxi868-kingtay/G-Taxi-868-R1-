...
-- =============================================================================
ALTER TABLE IF EXISTS public.watchdog_audit_log ENABLE ROW LEVEL SECURITY;
...
REVOKE EXECUTE ON FUNCTION expire_stale_withdrawal_codes() FROM PUBLIC, anon, authenticated;
