...
-- Replaces naive dispatch with PostGIS Geospatial Queries
-- Covers: 50km Radius, Vehicle Type Filtering, Distance Sorting

-- 1. Redefine Dispatch Function
...
BEGIN
    ...
    FOR v_driver IN 
        ...
        WHERE 
            ...
            AND is_online = true
            -- Vehicle Type Logic:
            -- Standard: Matches 'standard', 'xl', 'premium' (Upgrade allowed)
