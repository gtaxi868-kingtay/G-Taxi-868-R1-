...
const styles = StyleSheet.create({
    ...
    photoInitial: { color: '#FFFFFF', fontSize: 22, fontWeight: '600' },
    driverInfoSection: { flex: 1 },
    nameRatingRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 3 },
    driverName: { color: '#FFFFFF', fontSize: 17, fontWeight: '600' },
    ...
    fareAmount: { color: '#FFFFFF', fontSize: 36, fontWeight: '700', marginBottom: 8 },
    ...
    vehicleCardName: { color: '#FFFFFF', fontSize: 15, fontWeight: '600', marginBottom: 12 },
