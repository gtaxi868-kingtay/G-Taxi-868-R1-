...
const styles = StyleSheet.create({
    ...
    destCardSelected: { backgroundColor: 'rgba(29,224,230,0.1)', borderColor: 'rgba(29,224,230,0.3)' },
    emoji: { fontSize: 28 },
    ...
    saveBtn: { backgroundColor: '#8B5CF6', borderRadius: 20, paddingVertical: 16, alignItems: 'center' },
