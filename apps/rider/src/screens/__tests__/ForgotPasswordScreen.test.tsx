...
jest.mock('@gtaxi/design-system', () => ({ SURFACE: { base: '#141122' }, VOICES: { rider: { accent: '#d2bbff', accentDark: '#a88be0', textMuted: 'rgba(174,169,181,0.65)' } }, ANIMATION: { spring: { damping: 18, stiffness: 150, mass: 1 } } }));
