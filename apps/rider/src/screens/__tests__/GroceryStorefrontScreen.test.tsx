...
jest.mock('@gtaxi/design-system/native', () => { const R = require('react'); const { View, Text } = require('react-native'); return { LiquidGlass: ({ children }: any) => R.createElement(View, null, children), LoadingOverlay: 'LoadingOverlay' }; });
