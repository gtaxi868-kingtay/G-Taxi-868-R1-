...
jest.mock('@gtaxi/design-system-native', () => {
  ...
  return {
    // Missing before — same bug as rider/merchant-mobile's jest.setup.js: real
    // CrystalInput/CrystalButton/RainLogin exist and work, this mock's shape
    // just predates them, so every screen using them rendered undefined.
