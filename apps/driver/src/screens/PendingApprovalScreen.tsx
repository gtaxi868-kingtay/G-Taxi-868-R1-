    ...
    return (
        <View style={s.root}>
            ...
            <View style={s.content}>
                <LiquidGlass voice="driver" style={s.iconBox}>
                ...
                <LiquidGlass voice="driver" style={s.badge} tier="inlay">
...
const s = StyleSheet.create({
    ...
    iconBox: { width: 120, height: 120, alignItems: 'center', justifyContent: 'center', marginBottom: 8 },
    title: { textAlign: 'center', marginTop: 40, letterSpacing: -0.5 },
    description: { textAlign: 'center', marginTop: 20, lineHeight: 22, opacity: 0.8 },
    badge: { marginTop: 32, paddingHorizontal: 16, paddingVertical: 8 },
